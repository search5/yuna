...
class IncomingMailProcessingServiceSpec : DescribeSpec({
    ...
    val service = IncomingMailProcessingService(
        ...
        issueRepository, postingRepository, issueService, commentService,
    ...
    beforeTest {
        io.mockk.clearMocks(originalEmailRepository, userRepository, projectRepository, issueRepository, postingRepository, issueService, commentService)
